...
export default function Home() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbz1NmaRjSEr9fPJwVXVABV6RhXB6rWCaXOm1tE1CDwI1GERQrjFOcvK7y-8cak2XskBLA/exec";
  ...
  return (
    <>
      <Head>
        <title>Penggandaan NICE</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/p.WebP" />
      </Head>
      <Script
            ...
            <form name="regist-form">
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  <div className="info">
                    <p>
                      Notes : Dimohon untuk mengisi email leader team dengan
                      benar
                    </p>
                  </div>
                  <input
